...
The plot above shows the unemployment rate in % per province in the Netherlands. It indicates that the unemployment rate is highest in more urbanized provinces with the exception of the province of Groningen (upper right).
...
In the boxplots above, it is clearly visible that unemployment and crime are linked. The Youth category is more vulnarable to unemployment than the adult category, which in turn correlate with higher crime rates. Kessler et al. (2021) finds that reducing youth unemployment reduces youth criminality.
