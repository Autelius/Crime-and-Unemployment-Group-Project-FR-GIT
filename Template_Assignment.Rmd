...
```{r pop-heatmap, echo=FALSE, message=FALSE, warning=FALSE}
ggplot(nl_crime) +
...
```{r unemp-heatmap, echo=FALSE, message=FALSE, warning=FALSE}
ggplot(nl_crime) +
