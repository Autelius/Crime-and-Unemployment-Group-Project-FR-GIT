...
\pandocbounded{\includegraphics[keepaspectratio]{Template_Assignment_files/figure-latex/unnamed-chunk-3-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{Template_Assignment_files/figure-latex/unnamed-chunk-7-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{Template_Assignment_files/figure-latex/visualise_subpopulations-2.pdf}}
...
After the Oil-crisis in 1979, The Netherlands would experience
significant unemployment and crime per capita. According to
Ingeschiedenis.nl this was due to The Netherlands having a high budget
deficit and to little government intervention in accordance with the
Keynesian economic view of the time period (Bezuinigen En Hervormingen
in De Jaren '80, 2022). After the 2008 financial crisis The Netherlands
would find itself in a similar position with unemployment rising,
however crime per capita would fall in the next 5 years to historic
lows. What explains this phenomenon? An explanation by Ingschiedenis.nl
is that while the Netherlands decided after 1985 to reduce wages and the
budget deficit, The Netherlands in 2008 decided to increase spending,
this decision would be later reversed in the 2010's to a policy of
fiscal conservatism (Bezuinigen En Hervormingen in De Jaren '80, 2022).
A possible explanation for the movement of crime per capita in
